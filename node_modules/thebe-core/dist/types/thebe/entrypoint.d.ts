...
export interface JsApi {
    ...
    setupNotebookFromBlocks: (blocks: CodeBlock[], config: Config, rendermime: IRenderMimeRegistry) => ThebeNotebook;
    setupNotebookFromIpynb: (ipynb: INotebookContent, config: Config, rendermime: IRenderMimeRegistry) => ThebeNotebook;
}
