...
import { KernelManager, KernelSpecAPI, ServerConnection, SessionManager, } from '@jupyterlab/services';
...
class ThebeServer {
    ...
    static status(serverSettings) {
        return ServerConnection.makeRequest(`${serverSettings.baseUrl}api/status`, {}, ServerConnection.makeSettings(serverSettings));
    }
    getKernelSpecs() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.sessionManager)
                throw new Error('Must connect to a server before requesting KernelSpecs');
            return KernelSpecAPI.getSpecs(ServerConnection.makeSettings((_a = this.sessionManager) === null || _a === void 0 ? void 0 : _a.serverSettings));
        });
    }
    getContents(opts) {
        return __awaiter(this, void 0, void 0, function* () {
