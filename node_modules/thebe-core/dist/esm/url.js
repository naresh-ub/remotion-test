export function makeDefaultStorageKey(storagePrefix, url) {
...
export const GITHUB_SPEC = {
    name: 'github',
    makeUrls: makeGitHubUrl,
};
export const GITLAB_SPEC = {
    name: 'gitlab',
 ...
 *
 */
export function makeBinderUrls(config, repoProviders) {
    var _a, _b;
